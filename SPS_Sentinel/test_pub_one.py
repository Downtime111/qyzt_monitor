        ...
        while True:
            ...
            if min % (inval / 60) == 0 and sec == 0:
                    ...
                    for i in range(1, dev_num+1):
                        ...
                        msg = f"\"{now},{random.randint(0, 9)}.{random.randint(0, 50)},{random.randint(0, 9)}.{random.randint(0, 50)},{random.randint(0, 9)}.{random.randint(0, 1000)},0.{random.randint(0, 50)},{random.randint(0, 2)}.{random.randint(0, 50)},{random.randint(0, 20)}.{random.randint(0, 100)},0x0{random.randint(0, 9)}\""
